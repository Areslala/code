...
#         c2 = F.relu(self.bn1(self.conv2(x)))
#         c2 = F.max_pool2d(c2, kernel_size=3, stride=2, padding=1)
#         c3 = F.relu(self.bn1(self.conv3(x)))
#         c3 = F.max_pool2d(c3, kernel_size=3, stride=2, padding=1)
#         c4 = self.layer1(c3)
#         c5 = self.layer2(c4)
#         c6 = self.layer3(c5)
#         c7 = self.layer4(c6)
...
if __name__ == "__main__":
    ...
    model = RefineResnet101(size=300)
    print(model)
    with torch.no_grad():
        model.eval()
